...
class UserSubscriptionQuerySet(models.QuerySet):
    def by_range(self, days_start=7, days_end=120, verbose=True):
        ...
        if verbose:
            print(f"Filtering subscriptions with current_period_end between {range_start} and {range_end}")
        return self.filter(
    ...
    def by_days_left(self, days_left=7):
        ...
        return self.filter(
            ...
            current_period_end__lte=day_end) # gte and lte means greater than or equal to and less than or equal to.
